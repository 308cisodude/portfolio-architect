...
def test_expired_snapshot_stays_runtime_unavailable_and_health_is_consistent(tmp_path: Path) -> None:
    """Expired cached snapshots stay unavailable on every runtime read path."""
    config = _config(tmp_path)
