# Portfolio Architect Gateway runtime v1.45.0

Version 1.45.0 aligns the common Gateway runtime with the DKB provider-acquisition boundary release. Common REST/health/TLS contracts remain provider-neutral; the new DKB CSV parser stays provider-specific inside the DKB App.
