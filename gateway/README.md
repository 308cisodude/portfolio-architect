# Portfolio Architect Gateway runtime v1.33.1

Version 1.33.1 is package/User-Agent alignment for the Home Assistant-side recurring-schedule
anchor hotfix. The common server remains provider-neutral and its runtime,
