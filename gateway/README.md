# Portfolio Architect Gateway runtime v1.39.0

Version 1.39.0 is package/version alignment for Portfolio Architect's Home Assistant-side dynamic colourful current/target allocation presentation. The common Gateway runtime and provider acquisition are unchanged; the live-accepted v1.38.1 signed drift presentation, v1.38.0 cash/ISIN work, v1.37 shared human-numeric helper, Comdirect cash-policy behavior, v1.35.1 session-maintenance resilience, health schema 6, private-PKI HTTPS and bearer authentication remain intact.
