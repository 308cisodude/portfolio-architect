# Portfolio Architect Gateway runtime v1.44.0

Version 1.44.0 is package/version alignment for Portfolio Architect's Home Assistant-side Configure edit-context consistency release. The common Gateway runtime and provider acquisition are unchanged; Trade Republic statement acquisition, Comdirect session/cash behavior, health schema 6, private-PKI HTTPS and bearer authentication remain intact.
