# Portfolio Architect Gateway runtime v1.62.5

Version 1.62.5 is a package-alignment release for the common Gateway runtime. The coordinator-metadata hotfix is Home Assistant integration-only: provider acquisition, health schema 10, REST portfolio schema 1, provider identity, discovery transport and private-PKI behavior are unchanged from v1.62.4.
