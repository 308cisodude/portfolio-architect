# Portfolio Architect Gateway runtime v1.31.1

Version 1.31.1 is package alignment for the Home Assistant-side ISIN-only
outside-scope holding validation hotfix. Provider-aware execution routing remains the
