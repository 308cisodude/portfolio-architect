...
Version 1.27.1 makes the official provider Gateway REST boundary HTTPS-only and
...
Official v1.27.1 Gateway Apps use verified HTTPS on the private Home Assistant App network and retain bearer authentication. Never expose the Gateway REST port to an untrusted network.
