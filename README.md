...
Version 1.26.3 is a dashboard-only follow-up to the v1.26.2 UX release. It closes the remaining German unavailable-state presentation edge case and reorganises the policy-compliance section around actionable exception lifecycle information while retaining all machine-readable entities and provider/wire contracts unchanged.
