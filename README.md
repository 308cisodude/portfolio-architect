...
Version 1.47.0 adds independent DKB Girokonto cash evidence inside the DKB Gateway beside the existing depot-CSV holdings acquisition. Both evidence families remain private and independently timestamped; authenticated DKB FinTS remains gated and separate.
