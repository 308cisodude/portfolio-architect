...
A successful BPD response replaces an earlier failure state. DKB remains manual-only and non-live until later authenticated user-capability gates are separately implemented and accepted.
