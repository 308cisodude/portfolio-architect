...
Portfolio Architect 1.20.0 accepts REST portfolio schema 1, including the optional
...
Ingress transition. Gateway App 1.20.0 is protocol-compatible with 1.19.1 and is
