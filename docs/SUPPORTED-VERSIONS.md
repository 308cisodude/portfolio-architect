...
The 1.29.x release line requires Home Assistant 2026.7.0 or newer. CI validates
...
Portfolio Architect 1.29.0 accepts REST portfolio schema 1, including the optional
