...
The 1.30.x release line requires Home Assistant 2026.7.0 or newer. CI validates
...
Portfolio Architect 1.30.0 accepts REST portfolio schema 1, including the optional
