...
# Portfolio Architect v1.65.2 release notes

See [v1.65.2 read-only DKB cash research](RELEASE-NOTES-1.65.2.md) and [upgrade guide](UPGRADE-1.65.2.md).
...
> v1.64.5: see [RELEASE-NOTES-1.64.5.md](RELEASE-NOTES-1.64.5.md).
