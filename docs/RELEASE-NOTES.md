# Portfolio Architect v1.64.2 release notes

See [v1.64.2 DKB holdings research](RELEASE-NOTES-1.64.2.md) and [upgrade guide](UPGRADE-1.64.2.md).

## Previous release

> v1.64.1: see [RELEASE-NOTES-1.64.1.md](RELEASE-NOTES-1.64.1.md).
