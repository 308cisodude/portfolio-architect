# Portfolio Architect v1.64.3 release notes

See [v1.64.3 DKB holdings research](RELEASE-NOTES-1.64.3.md) and [upgrade guide](UPGRADE-1.64.3.md).

## Previous release

> v1.64.2: see [RELEASE-NOTES-1.64.2.md](RELEASE-NOTES-1.64.2.md).
