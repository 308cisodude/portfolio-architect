# Portfolio Architect Gateway — DKB v1.36.1

Version 1.36.1 is package alignment for Portfolio Architect's Home Assistant-side dynamic-dashboard hotfix. DKB remains experimental, manual-only and non-live; the anonymous registered FinTS capability probe is unchanged.
...
The v1.36.1 DKB App requests no DKB login name, PIN or TAN and sends no holdings, balance,
