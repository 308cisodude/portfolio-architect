# Portfolio Architect Gateway — DKB v1.30.0

Version 1.30.0 leaves the v1.28.0 DKB research boundary unchanged while aligning
the package with the provider-aware local execution-policy release. The DKB App still does not
...
with mode `0600`. No DKB login name, PIN or TAN is requested or stored in v1.30.0.
...
The v1.30.0 DKB App sends no holdings request and contains no order, transfer,
