# Portfolio Architect Gateway — DKB v1.55.1

Version 1.55.1: Version alignment only for the v1.55.1 Comdirect migration hotfix; DKB CSV acquisition and the anonymous FinTS research gate are unchanged.
