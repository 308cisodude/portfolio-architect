...
This is the separately installable DKB provider App boundary introduced in Portfolio Architect 1.24.0 and fixed for startup in 1.24.1.

It is deliberately **not yet a live portfolio source**. Its purpose in this release is to establish the independent Supervisor identity, private storage, read-only authenticated Gateway server, bounded `provider_id: dkb`, and future in-place upgrade path.
