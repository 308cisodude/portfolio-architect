# Portfolio Architect Gateway — DKB v1.41.1

Version 1.41.1 is package alignment for the Portfolio Architect local-cash routing tie-break hotfix. DKB remains experimental, manual-only and non-live; the registered anonymous FinTS capability probe is unchanged.
...
The v1.41.1 DKB App requests no DKB login name, PIN or TAN and sends no holdings, balance,
