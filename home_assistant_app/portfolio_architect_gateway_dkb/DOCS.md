# Portfolio Architect Gateway — DKB v1.62.3

Version 1.62.3 is a version-alignment release for this App. Supported CSV holdings/cash acquisition, private state, health schema 10, discovery transport, private-PKI/bearer boundary and no-fallback behavior are unchanged; authenticated FinTS remains disabled.
