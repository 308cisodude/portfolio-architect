# Portfolio Architect Gateway — DKB v1.28.2

Version 1.28.2 leaves the v1.28.0 DKB research boundary unchanged while aligning
the package with Dependabot workflow maintenance. The DKB App still does not
...
with mode `0600`. No DKB login name, PIN or TAN is requested or stored in v1.28.2.
...
The v1.28.2 DKB App sends no holdings request and contains no order, transfer,
