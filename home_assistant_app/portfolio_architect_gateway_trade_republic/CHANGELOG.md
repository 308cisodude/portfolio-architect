...
- Version-align this App with Portfolio Architect v1.63.0. Trade Republic PDF holdings/cash acquisition and reconciliation, private state, health schema 10, discovery transport, verified private-PKI/bearer trust and `fallback_policy: none` are unchanged; v1.63.0 changes only the static reference-dashboard source/build architecture and presentation.
