# Portfolio Architect Gateway — Trade Republic v1.55.1

Version 1.55.1: Version alignment only for the v1.55.1 Comdirect migration hotfix; Trade Republic PDF/statement acquisition is unchanged.
