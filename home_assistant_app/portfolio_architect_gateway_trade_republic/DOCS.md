...
Version 1.27.1 retains the supported local German text-PDF **DEPOTAUSZUG** importer
...
Update the Portfolio Architect Home Assistant integration to 1.27.1 before this App
