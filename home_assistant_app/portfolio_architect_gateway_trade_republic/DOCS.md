# Portfolio Architect Gateway — Trade Republic v1.61.0

Version 1.61.0 is package alignment for Portfolio Architect's Home Assistant-side Configure removal-confirmation UX. Trade Republic acquisition, health schema 9, canonical evidence clocks, private-PKI transport and no-fallback behavior are unchanged from v1.60.0.
