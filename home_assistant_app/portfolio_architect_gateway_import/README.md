# Portfolio Architect Gateway — Generic Import v1.54.0

Version 1.54.0 keeps Generic Import's fixed `csv` method and transient mapped-CSV boundary unchanged. Accepted canonical CSV snapshots remain servable with their original evidence timestamp instead of expiring under a separate Gateway cache TTL; Portfolio Architect decides freshness.
