# Portfolio Architect Gateway — Comdirect v1.62.4

Version 1.62.4 is a version-alignment release for this App. Provider acquisition, private state, health schema 10, discovery transport, private-PKI/bearer boundary and no-fallback behavior are unchanged from v1.62.3; the runtime hotfix is Home Assistant integration-only.
