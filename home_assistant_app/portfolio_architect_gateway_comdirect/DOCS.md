# Portfolio Architect Gateway — Comdirect v1.62.2

Version 1.62.2 is a version-alignment release for this App. Provider acquisition, private state, health schema 10, discovery transport, private-PKI/bearer boundary and no-fallback behavior are unchanged; the first-run explicit-choice fix is owned by the Home Assistant integration.
