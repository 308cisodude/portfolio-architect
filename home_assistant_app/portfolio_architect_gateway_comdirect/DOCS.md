# Portfolio Architect Gateway — Comdirect v1.61.1

Version 1.61.1 is package alignment for Portfolio Architect's Home Assistant-side provider-neutral Supervisor-discovery lifecycle hotfix. Comdirect acquisition, health schema 9, canonical evidence clocks, private-PKI transport and no-fallback behavior are unchanged from v1.61.0.
