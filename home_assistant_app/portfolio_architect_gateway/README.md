# Portfolio Architect Gateway — Comdirect v1.44.0

Version 1.44.0 is package alignment for the Portfolio Architect Configure edit-context consistency release. Comdirect OAuth/session maintenance, account selection, authorized cash, provider runtime and verified-HTTPS behavior are unchanged.
