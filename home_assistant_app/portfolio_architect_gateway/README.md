# Portfolio Architect Gateway App v1.20.1
...
Version 1.20.1 aligns the App package with Portfolio Architect's LKG
entity-propagation maintenance release. Gateway runtime, REST schema 1, health
schema 5, authentication, and cash-policy behavior remain unchanged from 1.20.0.
