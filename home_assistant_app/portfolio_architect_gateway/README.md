# Portfolio Architect Gateway — Comdirect App v1.24.1
...
Version 1.24.1 is the provider-shell startup hotfix for the distinct App architecture. The provider-aware common Gateway boundary and health
schema 6 remain unchanged. The App publishes the bounded non-secret `provider_id: comdirect` while
