...
- Comdirect `live_api`/`csv` acquisition, OAuth/session maintenance, static parsing and live/static Ingress semantics are unchanged from v1.49.0
...
- Package/version alignment for Portfolio Architect v1.43.0 route-level execution evidence and native funding-edge editing; Comdirect acquisition/OAuth/cash behavior is unchanged.
