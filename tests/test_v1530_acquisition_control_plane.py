"""v1.53.1 provider-neutral acquisition control-plane contracts."""
...
def test_v1530_versions_and_health_schema_are_aligned() -> None:
    ...
    assert '__version__ = "1.53.1"' in (ROOT / "gateway/src/portfolio_architect_gateway/__init__.py").read_text()
    for app in (
