...
def test_v1201_version_alignment_and_wire_compatibility() -> None:
    ...
    assert 'VERSION: Final = "1.62.1"' in const
    assert '__version__ = "1.62.1"' in engine
    assert '__version__ = "1.62.1"' in gateway
    ...
    assert "schema version 13" in integration_init
