...
def test_v1201_version_alignment_and_wire_compatibility() -> None:
    ...
    assert 'VERSION: Final = "1.54.0"' in const
    assert '__version__ = "1.54.0"' in engine
    assert '__version__ = "1.54.0"' in gateway
    ...
    assert '"requested_health_schema_version": 8' in rest_client
