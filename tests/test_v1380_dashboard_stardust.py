"""v1.55.1 native dashboard usability contracts."""
...
def test_v1380_metadata_dashboard_and_translation_contracts_are_aligned() -> None:
    assert 'version = "1.59.0"' in (ROOT / "pyproject.toml").read_text(encoding="utf-8")
    ...
    assert (ROOT / "docs" / "UPGRADE-1.59.0.md").is_file()
