...
DKB_PROVIDER_FILES={"dkb_app.py","dkb_cash_csv.py","dkb_cash_research.py","dkb_csv.py","dkb_fints.py","dkb_authenticated.py","dkb_holdings_research.py","dkb_holdings_review.py","dkb_shadow.py"}
...
def test_three_provider_apps_have_unique_lifecycle_identities_and_isolated_storage():
    ...
    assert all(c["version"]=="1.65.4" for c in configs.values())
