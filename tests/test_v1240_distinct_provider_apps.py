...
DKB_PROVIDER_FILES={"dkb_app.py","dkb_cash_csv.py","dkb_csv.py","dkb_fints.py","dkb_authenticated.py","dkb_holdings_research.py","dkb_holdings_review.py"}
...
def test_three_provider_apps_have_unique_lifecycle_identities_and_isolated_storage():
    ...
    assert all(c["version"]=="1.64.4" for c in configs.values())
