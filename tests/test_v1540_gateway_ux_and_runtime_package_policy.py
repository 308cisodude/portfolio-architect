"""v1.54.0 Gateway acquisition UX and runtime-package policy contracts."""
...
def test_v1540_keeps_gateway_wire_schemas_unchanged() -> None:
    ...
    assert json.loads((ROOT / "custom_components/portfolio_architect/manifest.json").read_text())["version"] == "1.54.0"
